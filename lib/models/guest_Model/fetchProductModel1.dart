import 'dart:convert';
FetchProductModel1 fetchProductModel1FromJson(String str) => FetchProductModel1.fromJson(json.decode(str));
String fetchProductModel1ToJson(FetchProductModel1 data) => json.encode(data.toJson());
class FetchProductModel1 {
  FetchProductModel1({
      this.status, 
      this.message, 
      this.data,});

  FetchProductModel1.fromJson(dynamic json) {
    status = json['status'];
