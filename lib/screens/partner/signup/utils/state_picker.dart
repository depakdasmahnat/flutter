...
class StatePicker extends StatelessWidget {
  ...
  final StatesData? selected;
  final List<StatesData>? list;
  final Color? color;
  final double? height;
  final double? radius;
  ...
  final Function(StatesData? value) onChanged;
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        StatesData? data = list?.elementAt(index);
