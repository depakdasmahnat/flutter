...
class SingleCategoryPicker extends StatelessWidget {
  const SingleCategoryPicker({
    Key? key,
    this.selected,
    this.list,
  ...
  final Function(CategoryData? value) onChanged;
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        CategoryData? data = list?.elementAt(index);
