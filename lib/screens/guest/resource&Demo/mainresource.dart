  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      await context
          ...
          .fetchInterestCategories(context: context, type: 'Resource');
    });
    super.initState();
  }
    ...
    return Scaffold(
      ...
      body: Consumer<GuestControllers>(
        builder: (context, controller, child) {
          return controller.fetchCategoryLoader == false
              ? const Center(
              ...
              : GridView.count(
                  ...
                  children: List.generate(
                    controller.fetchInterestCategory?.data?.length ?? 0,
                    (index) {
                      return Padding(
                              ...
                              child: Center(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      controller.fetchInterestCategory
                                              ?.data?[index].name ??
                                          '',
