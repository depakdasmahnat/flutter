  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      await context
          ...
          .fetchResourcesDetail(context: context, page: '1');
    });
    super.initState();
  }
    ...
    return Scaffold(
      ...
      body: Consumer<GuestControllers>(
        builder: (context, controller, child) {
          return controller.resourcesDetailLoader == false
              ? const Center(
              ...
              : ListView.builder(
                  itemCount:
                      controller.fetchResourcesDetailModel?.data?.length ?? 0,
                  shrinkWrap: true,
                    ...
                    return InkWell(
                        ...
                        child: FeedCard(
                          ...
                          networkImage: controller
                              .fetchResourcesDetailModel?.data?[index].file,
