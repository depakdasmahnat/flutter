...
class PickTimeSlotDates extends StatelessWidget {
  const PickTimeSlotDates({
    Key? key,
    this.selected,
    this.list,
  ...
  final PartnerTimeSlotDates? selected;
  final List<PartnerTimeSlotDates?>? list;
  final Color? color;
  final double? height;
  final double? radius;
  ...
  final Function(PartnerTimeSlotDates? value) onChanged;
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          PartnerTimeSlotDates? data = list?.elementAt(index);
          bool selectedItem = selected?.dateLabel == data?.dateLabel;
