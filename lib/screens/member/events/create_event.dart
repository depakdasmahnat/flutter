        ...
        children: [
          ...
          Padding(
            ...
            child: CustomDropdown(
              ...
              listItem: const ['Event','Seminar','Webinar','Meeting','Down Line Meeting'],
            ),
          ),
          // if(eventType=='Event'|| eventType=='Seminar'||eventType=='Meeting'||eventType=='Down Line Meeting'||)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
            child: IgnorePointer(
            ...
            builder: (context, controller, child) {
              return  Padding(
                ...
                child: CustomDropdown(
                  showSearchBox: true,
                  onChanged: (v) {
                    teamMeeting =controller.fetchSponsorModel?.data?.firstWhere((element) {
          ...
          GradientButton(
            ...
            onTap: () {
              context.read<MembersController>().createEvent(context: context,
                  ...
                  endDate: endDateCtrl.text, endTime: endTimeCtrl.text, memberIds: teamMeeting, file: XFile(image?.path??''), mode: eventMode, meetingType: members,);
