...
class FeedDetailsCard extends StatefulWidget {
  ...
  @override
  State<FeedDetailsCard> createState() => _FeedDetailsCardState();
}

class _FeedDetailsCardState extends State<FeedDetailsCard> {
...
class FeedMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(bottom: lastMenu != true ? kPadding : 0),
