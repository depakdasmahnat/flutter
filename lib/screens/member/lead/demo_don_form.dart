...
class _DemoDoneFormState extends State<DemoDoneForm> {
  ...
  List item = [
    ...
    'Need to talk with some friends and family',
    'Issue with pyramidal scheme'
  ];
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              decoration: ShapeDecoration(
                                  ...
                                  gradient: tabIndex == index
                                      ? primaryGradient
                                      : const LinearGradient(colors: [Color(0xFF1B1B1B), Color(0xFF1B1B1B)])),
                              child: Padding(
