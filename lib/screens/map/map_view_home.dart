...
import 'utils/map_product_card.dart';
...
class _MapViewHomeState extends State<MapViewHome> {
  ...
  fetchNearbyMapProducers() {
    ...
    dashboardController.fetchNearbyMapProducers(
      context: context,
      type: type,
  ...
  Widget build(BuildContext context) {
    ...
    nearbyMapProducersData = controller.nearbyMapProducersData;
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        body: Stack(
          ...
          children: [
            SizedBox(
              // height: size.height * (nearbyMapProducersData.haveData ? 0.52 : 1),
              child: GoogleMap(
                ...
                children: [
                  ...
                  Flexible(
                    child: CustomTextField(
                      ...
                      onChanged: (val) async {
                        if (controller.loadingNearbyMapProducers == false) {
                  ...
                  return SafeArea(
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children: [
                          DataWidgetBuilder(
                            isLoading: controller.loadingNearbyMapProducers,
                            haveData: nearbyMapProducersData.haveData,
                            heightFactor: 0.5,
                            child: ListView.builder(
                              shrinkWrap: true,
                              // itemCount: 15,
                              itemCount: nearbyMapProducersData?.length ?? 0,
                              keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
                              padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 12),
                              physics: const NeverScrollableScrollPhysics(),
                              itemBuilder: (BuildContext context, int index) {
                                NearByMapProducersData? data = nearbyMapProducersData?.elementAt(index);
        ...
        ), // bottomSheet: nearbyMapProducersData.haveData
        //     ? Container(
        //         height: size.height * 0.5,
        //         padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom),
        //         decoration: BoxDecoration(
