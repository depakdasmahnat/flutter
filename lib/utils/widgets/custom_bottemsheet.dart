...
class CustomeModelBottemSheet extends StatefulWidget {
  String? title;
  int? listItem;
  int? tabIndex;
   CustomeModelBottemSheet({super.key,this.title,this.listItem,this.tabIndex});

  @override
  State<CustomeModelBottemSheet> createState() => _CustomeModelBottemSheetState();
}

class _CustomeModelBottemSheetState extends State<CustomeModelBottemSheet> {
  @override
