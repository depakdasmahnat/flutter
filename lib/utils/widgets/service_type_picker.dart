...
class AllServiceTypePicker extends StatelessWidget {
  const AllServiceTypePicker({
    Key? key,
  ...
  final AllServiceType selected;
  final List<AllServiceType> list;
  final Color? color;
  final double? height;
  final double? radius;
  ...
  final Function(AllServiceType value) onChanged;
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        AllServiceType data = list.elementAt(index);
