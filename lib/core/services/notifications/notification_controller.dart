...
class NotificationController with ChangeNotifier {
    ...
    await AwesomeNotifications().initialize(
      ...
      [
        NotificationChannel(
          ...
          channelName: AppConfig.name,
          channelDescription: '${AppConfig.name} Notifications',
  ...
  static setFirebaseMessagingListeners({required BuildContext context}) {
  ...
  static openScreen({
    ...
    return context.pushNamed(route ?? Routs.notifications);
  }
